...
def plot_cluster_results(xml_paths, cluster_assignments):
    ...
    for cluster_id in unique_clusters:
        ...
        for idx in cluster_indices:
            plt.scatter(cluster_id, idx, marker=symbols[cluster_id % len(symbols)], color=colors[cluster_id % len(colors)], label=cluster_label)
...
xml_file_paths = ["../testingfiles/city1.xml", "../testingfiles/city2.xml", "../testingfiles/city3.xml","../testingfiles/city4.xml","../testingfiles/food1.xml", "../testingfiles/food2.xml"]
